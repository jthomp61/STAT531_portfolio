...
NOTE: Items I have altered form my Lab8 submission will be indicated with [\*\***Changed\*\***]{.underline}
...
sing_day <- function(dataset, line, phrase_col) {
  ...
  ## Changed! Added a camma after Christmas
  intro <- glue::glue("On the {num_word} day of Christmas,")
  
  phrases <- dataset |>
    pull( {{phrase_col}} )
  
  ## Changed! Added cammas before the new line and before 'and' 
  needed_phrases <- glue::glue_collapse(phrases[line:1], 
                                        sep = ",\n", 
                                        last = ", and \n")

  ## Changed! Added a period at the end of the day phrase.
