...
## **2 Is Dr. Theobold's first name not cool any more?**
...
1.  In California, Allan's spelling of his name is the least common of the three
...
How do I make the numbers in the table display '%' symbols? For example, `65.3%` , `19.9%` ... ? Without having to convert the contents of the column vector into stings and adding a percent at the end?
