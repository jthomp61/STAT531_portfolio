...
Like sometimes efficient code isn't what we want because readability is low and the point of code for data scientist is for someone to read the code. 

then there is actually having efficient code in terms for speedy code. Not having unnecessary steps or repeating of code that can both reduce readability and
